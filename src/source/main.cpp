...
int main() {
	...
	Options options;
	options.set_supersampling_levels(0);
	...
	const Material sphere0_material(Color(255, 0, 255), 10000, 1.0f, 1.52f, 1.0f);
	...
	scene.Add(Sphere(Point(0, -1, 5), 1, sphere3_material));
